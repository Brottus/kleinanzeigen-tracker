...
API_URL = '/openapi.yaml'  # Path to OpenAPI spec
...
# Conditionally register Swagger UI blueprint
# This will be done in __main__ after ENABLE_SWAGGER_UI is set
...
if __name__ == '__main__':
    ...
    print('=' * 60)
    print(f'Starting Kleinanzeigen Scraper API v{VERSION}')
