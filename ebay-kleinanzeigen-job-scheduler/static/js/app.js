        ...
        if (key === 'default_job_schedule') {
            ...
            const cronHelp = currentLanguage === 'de' 
                ? `Cron-Format: Minute Stunde Tag Monat Wochentag<br>
                   Beispiel: */30 * * * * = alle 30 Minuten | 0 8 * * * = täglich um 8:00 Uhr<br>
                   <a href="https://crontab.guru/" target="_blank" style="color: var(--primary);">Nutzen Sie crontab.guru für Hilfe</a>`
